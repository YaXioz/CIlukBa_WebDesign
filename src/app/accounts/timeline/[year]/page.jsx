  ...
  return (
    <div className="w-full flex bg-gradient-to-br from-[#1A0733] to-[#5E27D1]">
      <div className="mt-16 container flex justify-between gap-8 flex-row mx-auto px-12">
        ...
        <div className="container bg-inherit rounded-lg flex flex-col items-center h-screen">
          <Link className="w-4/5" href={"/accounts"}>
            <div className="bg-[#6E27D1] text-white py-3 px-4 rounded-lg text-center font-semibold transition-transform transform hover:scale-105 hover:shadow-lg">&lt; Back</div>
          </Link>
          ...
          <div className="absolute bottom-0 w-16 h-32 bg-inherit left-1/2 transform -translate-x-1/2">
            <Link href={`/accounts/post/new/${params.year}`}>
              <div className="py-4 px-4 bg-[#6E27D1] hover:text-white text-[#d5d5d5] rounded-3xl text-center shadow-lg flex flex-col items-center transition-transform transform hover:scale-105">
