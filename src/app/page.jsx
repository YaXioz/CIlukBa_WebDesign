...
export default function Page() {
  return (
    <div className="w-screen h-screen relative bg-[#000000] overflow-hidden [mask-image:linear-gradient(to-bottom,transparent,black_10%,black_90%,transparent)]">
      ...
      {/* SubTitle */}
      <div className="subTittle text-center lg:pt-5 md:pt-4 sm:pt-3 text-white/60 lg:text-2xl sm:text-base md:text-xl font-thin font-montserrat z-10 relative">Your personal page to show the precious moments in your life</div>
      ...
      >
        ...
        <Link className="buttonText lg:left-[13px] md:left-[13px] sm:left-[12px] -top-5 lg:mt-8 md:mt-8 sm:mt-8 absolute text-white lg:text-lg md:text-base sm:text-sm font-semibold font-montserrat" href="/signup">
